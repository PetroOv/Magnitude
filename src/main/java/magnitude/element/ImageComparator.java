...
public class ImageComparator {
    ...
    public static void main(String[] args) throws IOException {
        BufferedImage img1 = ImageIO.read(new File("rofl12.png"));
        BufferedImage img2 = ImageIO.read(new File("rofl12a.png"));
        ImageComparator imageComparator = new ImageComparator(img1,img2);
        imageComparator.createCompositeImage(new File("./roflCompare.png"));
        System.out.println(imageComparator.diffCount);
        ImageDiffer imageDiffer = new ImageDiffer();
        BufferedImage comparedImage = imageDiffer.makeDiff(img1,img2).getMarkedImage();
        ImageIO.write(comparedImage, "png", new File("./roflCompareAShot.png"));
    }
